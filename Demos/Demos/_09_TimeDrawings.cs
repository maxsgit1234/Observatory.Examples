...
namespace Demos
{
    ...
    {
        public string Title { get { return "Time Plots"; } }
        public string Description { get { return "Make a plot where one or more axes represent dates and times."; } }
        ...
        public void Run()
        {
            ...
            DateTime start = new DateTime(2024, 03, 15);
            DateTime end = new DateTime(2024, 05, 15);
